<?php 
  ...
  if(! isset($_REQUEST['item']))
    die(__('This file cannot be accessed directly', 'ucfeed'));
  else 
  {
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body id="help">
    ...
    <div id="header">
      <h1>Ultimate-Coupon-Feed <?php _e('Help', 'ucfeed') ?></h1>
      
      <a href="#" id="link_close"><?php _e('Close window', 'ucfeed') ?></a>
    </div>
    
    <div id="content">
      <?php echo ($content) ? $content : __('Help file not found', 'ucfeed') ?>
    </div>
  </body>
</html>